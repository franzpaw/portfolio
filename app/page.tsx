...
export default function Home() {
  return (
    <main className="container mx-auto mt-12">
      <div className="">
        <h1 className="font-georgia text-black dark:text-gray-100 text-5xl">Franz Pawlus</h1>
        <p className="mt-4 ">
        ...
        <div className="flex gap-10 justify-start items-center mt-10">
          ...
          <div className="flex flex-col text-gray-600 dark:text-gray-500">
            <p className="flex items-center hover:text-black hover:dark:text-white"><Github className="mr-2 h-5" /> GitHub</p>
            <p className="flex items-center hover:text-black hover:dark:text-white "><Instagram className="mr-2 h-5" /> Instagram</p>
            <p className="flex items-center hover:text-black hover:dark:text-white"><Linkedin className="mr-2 h-5" /> LinkedIn</p>
          </div>
        </div>
        ...
        <div className="mt-10 flex">
          <a href="https://twitter.com/leerob" className="text-gray-600 dark:text-gray-500 flex items-center hover:text-white">
            <ArrowUpRight className="mr-1" /> my projects
          </a> 
          <a href="https://leerob.io" className="text-gray-600 dark:text-gray-500 flex items-center hover:text-white">
